          ...
          <div style={{borderBottom: "solid #D7D9D7 0.01rem"}} className="players">
            <div className="row">
              <div className="col"> 
                ...
                <p>Latest registrant is <span style={{color: "#4472CA"}}><i>{this.props.userList[this.props.userList.length - 1].firstName} {this.props.userList[this.props.userList.length - 1].lastName}</i></span></p>
              </div>
            </div>
          </div>
          <br/>
